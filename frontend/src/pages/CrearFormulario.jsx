...
const CrearFormulario = () => {
  ...
  const [meta, setMeta] = useState({
    titulo: "",
    descripcion: "",
    tipo: "", // Este es el ID interno (ej: "encuesta_final")
  });
  ...
  const handleSave = async (esquemaPreguntas) => {
    ...
    if (!meta.titulo || !meta.tipo) {
      showErrorAlert(
        "Faltan datos",
        "Debes ponerle un Título y un Código Único al formulario."
      );
      return;
    }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setMeta({
                    ...meta,
                    tipo: e.target.value.toLowerCase().replace(/\s+/g, "_"),
                  })
                }
              />
              <p className="text-xs text-gray-400 mt-1">
                Este código sirve para identificarlo en el sistema.
              </p>
            </div>
