...
import { getTodasLasPlantillas, eliminarPlantilla } from "../services/formulario.service";
import { Edit, FileText, Settings, Loader, Eye, Plus, Trash2 } from "lucide-react";
  ...
  const handleDelete = async (id, titulo) => {
    deleteDataAlert(async () => {
        try {
            ...
            showSuccessAlert("Eliminado", `El formulario "${titulo}" ha sido borrado.`);
          ...
          {plantillas.map((plantilla) => {
            ...
            return (
                ...
                <div className="flex items-start justify-between mb-4">
                    ...
                    <span className={`px-2 py-1 text-xs font-medium rounded-full uppercase ${esProtegido ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-600'}`}>
                ...
                <div className="flex gap-3">
                    ...
                    {!esProtegido && (
                        <button
                            onClick={() => handleDelete(plantilla.id, plantilla.titulo)}
