...
const Access = () => {
  ...
  // busca entre todas las respuestas de la práctica (postulación, evaluación, etc.)
...
>>>>>>> origin/javii4
  ...
  const getEvaluacionInicial = () => {
    ...
    const permitido = new Set(
      plantilla.esquema.map((c) => c.id).filter(Boolean)
    );
    const merged = { ...base };
  ...
  // para recargar los formularios disponibles
  ...
  // para enviar el formulario completado
  ...
  // para descargar PDF del formulario
  const handleDescargarPDF = async () => {
    ...
    const opt = {
      margin: [10, 10, 10, 10],
      filename: `${nombreTipo[formularioVisualizando?.tipo] || "Formulario"}_${
        data?.alumnoNombre || "Alumno"
      }.pdf`,
  ...
  // Estados Clave
  const esModoEdicion =
    (estado === "enviada_a_empresa" || estado === "rechazada") &&
    !modoEvaluacion;
          ...
          <div className="bg-white rounded-xl shadow-lg border border-blue-100 overflow-hidden">
            <div className="bg-blue-600 p-4 text-white">
              ...
              <p className="text-blue-100 text-sm mt-1">
                Por favor complete los datos requeridos para formalizar la
                solicitud.
              </p>
            </div>
            ...
            <div className="p-6">
              {plantilla ? (
                <FormRender
                  ...
                  buttonText={
                    procesando ? "Enviando..." : "Enviar a Validación"
                  }
                  userType="empresa"
                />
              ) : (
        ...
        {esPendienteValidacion && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-8 text-center">
            ...
            <p className="text-yellow-700 max-w-md mx-auto">
              Hemos recibido sus datos. La solicitud está siendo revisada por el
              Coordinador de Prácticas de la universidad.
            </p>
            <p className="text-sm text-yellow-600 mt-4 font-medium">
              Le notificaremos cuando sea aprobada.
            </p>
          </div>
        )}
        ...
        {esEnCurso && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
            ...
            <p className="text-green-700 mb-6">
              El alumno está activo. Al finalizar el periodo, podrá realizar su
              evaluación aquí.
            </p>
            <button
          ...
          <div className="bg-white rounded-xl shadow-lg border border-green-100 overflow-hidden mt-6">
            <div className="bg-green-600 p-4 text-white">
              ...
              <p className="text-green-100 text-sm mt-1">
                Complete la evaluación del alumno.
              </p>
            </div>
            <div className="p-6">
              <FormRender
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Enviado:{" "}
                          {form.fechaEnvio
                            ? new Date(form.fechaEnvio).toLocaleDateString()
                            : "N/A"}
                        </p>
                      </div>
                    </div>
